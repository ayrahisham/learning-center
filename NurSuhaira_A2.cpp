...
//and I am willing to accept whatever penalty given to me
//and also to all the related parties involved”
...
void analysisLHS(VoidPtr *, VoidPtr *, VoidPtr *, VoidPtr *, VoidPtr *, int, int, int, int&, int&);

void analysisRHS(VoidPtr *, VoidPtr *, VoidPtr *, VoidPtr *, VoidPtr *, VoidPtr*, int, int, int, int&, int&, int&);
...
void distributiveLaw()
{
	...
	int sizeLHS = 0, sizeRHS = 0, unionL = 0, interAB = 0, interAC = 0;
	
	analysisLHS (A, B, C, UnionL, IntersectL, sizeA, sizeB, sizeC, unionL, sizeLHS);
	
	analysisRHS (A, B, C, UnionR, IntersectAB, IntersectAC, sizeA, sizeB, sizeC, interAB, interAC, sizeRHS);
...
void analysisLHS (VoidPtr *A, VoidPtr *B, VoidPtr *C, VoidPtr *UnionL, 
				 VoidPtr *IntersectL, int sizeA, int sizeB, int sizeC, int& size, int& sizeLHS)
{
	printPartition();
...
void analysisRHS(VoidPtr *A, VoidPtr *B, VoidPtr *C, VoidPtr *UnionR, 
				VoidPtr *IntersectAB, VoidPtr *IntersectAC, int sizeA, 
				int sizeB, int sizeC, int& sizeAB, int& sizeAC, int& sizeRHS)
{
	printPartition();
